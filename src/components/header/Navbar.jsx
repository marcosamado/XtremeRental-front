...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row items-center justify-around md:justify-around">
      ...
      <button onClick={handleOpenNavbar} className="flex flex-col md:hidden">
      ...
      >
        ...
        <ul className={`flex flex-col text-left gap-1 text-xl text-white mt-5`}>
          ...
          <Link to="/carrito" onClick={handleClosenavbar}>
            <li className="hover:bg-orangeMain rounded-sm p-2">Carrito</li>
          </Link>
        </ul>
      </div>
